...
//			artist.setDebutDate(Date.valueOf("2024-05-"+(i+1)));
//			artist.setArtistName("아티스트"+i);
//			artist.setArtistInfo("<p>아티스트"+i+"</p>");
//			artist.setMember(userRepository.findByUserNo(i));
//			artist.setMusicCategory("이거랑저거");
//			artistRepository.save(artist);
//		}
//		for(int i = 1; i < 20; i++){
//			ImgUrl iu = new ImgUrl();
//			iu.setImgUrl("chuu");
//			iu.setFabcType(FabcTypeEnum.ARTIST);
//			iu.setContentNo(i);
//			iu.setKcType(KcTypeEnum.KING);
//			imgUrlRepository.save(iu);
//
//		}
	}
}